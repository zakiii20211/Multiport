...
trojanlink3="trojan://${uuid}@104.22.39.195:${tr}?type=ws&security=tls&host=${domain}&path=CF-VINS:http://ufuture.uitm.edu.my/trojan-tls&sni=ufuture.uitm.edu.my#XRAY_TROJAN_MAXIS_${user}"
trojanlink4="trojan://${uuid}@162.159.134.61:${trnone}?type=ws&security=none&host=${domain}&path=/trojan-ntls#XRAY_TROJAN_DIGI_${user}"
trojanlink5="trojan://${uuid}@104.20.65.29:${tr}?type=ws&security=tls&host=${domain}&path=CF-VINS:http://onlinepayment.celcom.com.my/trojan-tls&sni=onlinepayment.celcom.com.my#XRAY_TROJAN_CELCOM_${user}"
trojanlink6="trojan://${uuid}@104.17.112.188:${trnone}?type=ws&security=none&host=${domain}&path=CF-VINS:http://cdn.who.int/trojan-ntls#XRAY_TROJAN_YES_${user}"
...
clear
echo -e "\e[33m╒════════════════════════════════════════════╕\033[0m"
echo -e " \E[1;48;39m                [XRAY TROJAN WS]                 \E[0m"
echo -e "\e[33m╘════════════════════════════════════════════╛\033[0m"
echo -e "Remarks           : ${user}"
